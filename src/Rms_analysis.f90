...
!! Author: An-Ke Lei, August 2023 - August 2025.
...
!!                                 Last updated by An-Ke at GZNU on 19/12/2025
...
!       implicit none
        ...
        integer :: n_current_date_and_time(8)
        ...
        real(kind=8) :: sum_sigma_NN_tot_parini, sum_sigma_NN_tot_hadcas, sum_sigma_eN_tot_parini
...
! Cycles over all of the "../PACIAE_i/rms.out" files.
        loop_file: do i_file=1,n_file,1
            ...
            INQUIRE( file = TRIM( ADJUSTL( name_file ) ), exist = file_exists )
            if( .NOT.file_exists ) cycle
            open( unit=99, file = TRIM( ADJUSTL( name_file ) ), status = "old" )
            n_file_actual = n_file_actual + 1
            ...
            ! #! NN(pp), eN(e^- p) total cross section in parini (mb) =
            i_line = i_line + 1
            read(99,"(A3000)") comment_line( i_line )
            ! Data.
            read(99,*) sigma_NN_tot_parini, sigma_eN_tot_parini
                sum_sigma_NN_tot_parini = sum_sigma_NN_tot_parini + sigma_NN_tot_parini
                sum_sigma_eN_tot_parini = sum_sigma_eN_tot_parini + sigma_eN_tot_parini
            ...
            read(99,"(A3000)") comment_line( i_line )
            ! Data.
            read(99,*) i_b_sampling_method, ave_b_param,   &
                       Npart_Optical_Glauber_proj, Npart_Optical_Glauber_targ,   &
...
! #! NN(pp) total cross section in parini (mb) =
        ...
        write(100,*) TRIM(ADJUSTL( comment_line( i_line ) ))
! Data.
        write(100,*) sum_sigma_NN_tot_parini, sum_sigma_eN_tot_parini
! #! NN(pp), eN(e^- p) total cross section in hadcas (mb) =
        i_line = i_line + 1
        write(100,*) TRIM(ADJUSTL( comment_line( i_line ) ))
! Data.
